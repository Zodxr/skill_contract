...
pub trait ICourseManager<TContractState> {
    ...
    fn update_progress(ref self: TContractState, student_address: ContractAddress, course_id: u256, progress: u8) -> bool;
    fn complete_course(ref self: TContractState, student_address: ContractAddress, course_id: u256, final_score: u256) -> bool;
    
    // View Functions
    fn get_course(self: @TContractState, course_id: u256) -> Course;
    fn get_enrollment(self: @TContractState, student_address: ContractAddress, course_id: u256) -> Enrollment;
    ...
    fn is_student_enrolled(self: @TContractState, student_address: ContractAddress, course_id: u256) -> bool;
}
...
pub mod CourseManager {
    ...
    use super::{Course, Enrollment, UserRole, ICourseManager};
    ...
    #[constructor]
    fn constructor(ref self: ContractState, admin: ContractAddress, user_registry: ContractAddress) {
    ...
    fn assert_user_role(self: @ContractState, user_address: ContractAddress, expected_role: UserRole) {
        let user_registry = IUserRegistryDispatcher { contract_address: self.user_registry.read() };
    ...
    impl CourseManagerImpl of ICourseManager<ContractState> {
        ...
        fn update_progress(ref self: ContractState, student_address: ContractAddress, course_id: u256, progress: u8) -> bool {
            let caller = get_caller_address();
            let course = self.courses.read(course_id);
        ...
        fn complete_course(ref self: ContractState, student_address: ContractAddress, course_id: u256, final_score: u256) -> bool {
            let caller = get_caller_address();
            let course = self.courses.read(course_id);
        ...
        fn get_enrollment(self: @ContractState, student_address: ContractAddress, course_id: u256) -> Enrollment {
        ...
        fn get_student_courses(self: @ContractState, student_address: ContractAddress) -> Array<u256> {
        ...
        fn is_student_enrolled(self: @ContractState, student_address: ContractAddress, course_id: u256) -> bool {
